...
export const Survey = (props) => {
  ...
  function form() {
      run({
        ...
        styles: {"direction":"vertical","verticalAlignment":"middle","hidePast":false,"hideUpcoming":false,"showNavigation":"auto","showProgressbar":true,"showEnumerators":false,"autoFocus":false,"showSeparateSubmit":true,"showPreviousButton":true,"showScrollbar":false,"noBranding":true,"contract":{"name":"tripetto-runner-autoscroll","version":"4.0.1"},"background":{"color":"E9F6F4"},"font":{"size":16},"navigation":{"progressbarColor":"63A298"},"buttons":{"baseColor":"63A298","mode":"fill","roundness":8}},
        attachments,
        onSubmit
    });
  }
